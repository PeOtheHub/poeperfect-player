...
public sealed class SeriesCatalogService
{
    ...
    public IReadOnlyList<SeriesGroupItem> BuildGroups(IEnumerable<PlaylistChannel> channels)
    {
        return channels
    ...
    private static ParsedEpisode ParseEpisode(PlaylistChannel channel, int originalIndex)
    {
